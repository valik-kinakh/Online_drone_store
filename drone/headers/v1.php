<header id="apus-header" class="site-header hidden-sm hidden-xs  header-v1 <?php echo (drone_apus_get_config('keep_header') ? 'main-sticky-header' : ''); ?>" role="banner">
	<div id="apus-topbar" class="apus-topbar">
		<div class="container">
            <div class="topbar-inner clearfix">
                ...
                <?php endif; ?>
                <?php if ( is_active_sidebar('currency-switcher') ): ?>
            ...
            <div class="header-center-inner clearfix">
                <div class="row">
                    ...
                    <div class="logo-in-theme col-md-2">
                        <?php get_template_part( 'page-templates/parts/logo-black' ); ?>
                    </div>
                    <!-- //LOGO -->
