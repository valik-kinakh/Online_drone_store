...
jQuery( document).ready( function($){
    ...
    //Sticky Header
    var main_sticky = $('body.home .main-sticky-header');
    if ( main_sticky.length > 0 ){
        ...
        var ApusHeaderSticky = function() {
            ...
            if ( $(document).scrollTop() > ( _header_action + _header_action_width ) ) {
	...
	$('[data-countdown="countdown"]').each(function(index, el) {
        ...
        $this.countdowntimer({
            ...
            regexpReplaceWith:"<div class=\"countdown-wrapper\"><div class=\"day\">$1 DAYS </div><div class=\"hours\">$2 HOURS </div><div class=\"minutes\">$3 MINUTES </div><div class=\"seconds\">$4 SECONDS </div></div>"
        });
    });
