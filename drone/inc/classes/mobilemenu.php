...
if ( !class_exists("Drone_Mobile_Menu") ) {
    class Drone_Mobile_Menu extends Walker_Nav_Menu {
       ...
       /**
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if (isset($item->apus_highlight) && $item->apus_highlight) {
                $class_names .= ' ' . $item->apus_highlight;
            }
            ...
            if ( isset($item->apus_text_label) && !empty($item->apus_text_label) ) {
                switch ( $item->apus_text_label ) {
                    case 'label_new':
                        $text_label  = esc_html__('New', 'drone');
                        break;

                    case 'label_hot':
                        $text_label  = esc_html__('Hot', 'drone');
                        break;

                    case 'label_featured':
                        $text_label  = esc_html__('Featured', 'drone');
                        break;
            ...
            $item_output .= '</a>';
            $item_output .= $args->has_children || $apus_mega_profile ? ' <span class="icon-toggle"><i class="fa fa-angle-right"></i></span>' : '';
