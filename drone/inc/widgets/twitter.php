...
class Drone_Apus_Twitter_Widget extends Apus_Widget{

    public function __construct() {
         parent::__construct(
            'apus_twitter_widget',
            esc_html__('Apus Latest Twitter', 'drone'),
            array( 'description' => esc_html__( 'Latest Twitter widget.', 'drone' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $defaults = array(
            'title' => esc_html__('Latest tweets.', 'drone'),
            'user' => esc_html__('Leotheme', 'drone'),
        ...
        $values = array(
            1 => esc_html__('Yes', 'drone'),
            0 => esc_html__('No', 'drone'),
        );              
        $instance = wp_parse_args( (array) $instance, $defaults ); ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title:', 'drone'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user' )); ?>"><?php esc_html_e('Twitter Username:', 'drone'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'limit' )); ?>"><?php esc_html_e('Limit:', 'drone'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'twitter_id' )); ?>"><?php esc_html_e('Twitter Id:', 'drone'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_color' )); ?>"><?php esc_html_e('Border Color:', 'drone'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'link_color' )); ?>"><?php esc_html_e('Link Color:', 'drone'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_color' )); ?>"><?php esc_html_e('Text Color:', 'drone'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'name_color' )); ?>"><?php esc_html_e('Name Color:', 'drone'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mail_color' )); ?>"><?php esc_html_e('Mail Color:', 'drone'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'transparent' )); ?>"><?php esc_html_e('Show background', 'drone'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_replies' )); ?>"><?php esc_html_e('Show Replies', 'drone'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_header' )); ?>"><?php esc_html_e('Show Header', 'drone'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_footer' )); ?>"><?php esc_html_e('Show Footer', 'drone'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_border' )); ?>"><?php esc_html_e('Show Border', 'drone'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_scrollbar' )); ?>"><?php esc_html_e('Show Scrollbar', 'drone'); ?></label>
            <br>
...
register_widget( 'Drone_Apus_Twitter_Widget' );
