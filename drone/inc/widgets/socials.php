...
class Drone_Apus_Socials_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'drone'),
            array( 'description' => esc_html__( 'Socials for website.', 'drone' ), )
        );
...
register_widget( 'Drone_Apus_Socials_Widget' );