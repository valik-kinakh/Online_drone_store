...
class Drone_Apus_Facebook_Like_Box extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_facebook_like',
            esc_html__('Apus Facebook Like Box', 'drone'),
            array( 'description' => esc_html__( 'Adds support for Facebook Like Box. ', 'drone' ), )
        );
...
register_widget( 'Drone_Apus_Facebook_Like_Box' );