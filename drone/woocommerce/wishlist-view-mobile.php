...
<ul class="shop_table cart wishlist_table wishlist_view responsive mobile <?php echo $show_cb ? 'with-checkbox' : '' ?>" data-pagination="<?php echo esc_attr( $pagination )?>" data-per-page="<?php echo esc_attr( $per_page )?>" data-page="<?php echo esc_attr( $current_page )?>" data-id="<?php echo $wishlist_id ?>" data-token="<?php echo $wishlist_token ?>">
    ...
    if( $wishlist && $wishlist->has_items() ) :
                            ...
                            <div class="additional-info-wrapper">
                                    ...
                                    <table class="additional-info">
                                        ...
                                        <?php if( $show_stock_status ) : ?>
                                            <tr>
                                                ...
                                                <td class="value">
                                                    <?php echo $stock_status == 'out-of-stock' ? '<span class="wishlist-out-of-stock">' . __( 'Out of stock', 'drone' ) . '</span>' : '<span class="wishlist-in-stock">' . __( 'In Stock', 'drone' ) . '</span>'; ?>
                                                </td>
                                            </tr>
                                        <?php endif ?>
                                    </table>
                                ...
                                <?php if( $is_user_owner && $repeat_remove_button ): ?>
                                    <div class="product-remove">
                                            <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ) ?>" class="remove_from_wishlist" title="<?php echo apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'drone' ) ); ?>"><i class="fa fa-trash"></i></a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <p class="wishlist-empty">
            <?php echo apply_filters( 'yith_wcwl_no_product_to_remove_message', __( 'No products added to the wishlist', 'drone' ) ) ?>
        </p>
    <?php
    endif;
