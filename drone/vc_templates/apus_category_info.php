...
?>
    <div class="widget <?php echo esc_attr($el_class); ?>">
        ...
        <div class="widget-content">
            <div class="apus-category-info">
                <div class="category-info-content">
                    <div class="info-head">
                        <h4 class="category-info-title"><span><?php echo trim($term->name); ?></span></h4>
                        <small><?php echo trim($term->count); ?> <?php esc_html_e( 'Products' ,'drone');?></small>  
                    </div>
                    <?php
                    ...
                    <div class="category-info-link">
                        <a href="<?php echo esc_url( get_term_link( $term->term_id, 'product_cat' ) ); ?>" title="<?php echo esc_html__( 'more', 'drone'); ?>" class=""><?php echo esc_html__( '+ more...', 'drone' ); ?></a>
                    </div>
                </div>
