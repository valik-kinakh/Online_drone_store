...
$class_to_filter = 'wpb_single_image widget wpb_content_element vc_align_' . $alignment . ' ' . $this->getCSSAnimation( $css_animation );
...
$output = '
	<div class="' . esc_attr( trim( $css_class ) ) . '">
		' . wpb_widget_title( array( 'title' => $title, 'extraclass' => 'wpb_singleimage_heading widget-title title-lg space-10' ) ) . '
